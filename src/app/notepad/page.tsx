...
// payment cards) on every save — this page merely displays what the server
  ...
  const save = useCallback(async () => {
    ...
    try {
      ...
      if (d.redactions > 0) {
        ...
        flashNotice(`Ziplod protected ${d.redactions} sensitive ${d.redactions === 1 ? "item" : "items"} (SSN / DOB / card).`);
      }
  ...
  return (
    <div className="h-screen flex flex-col bg-white">
      ...
      <div className="flex items-center gap-3 px-4 py-2 border-b border-slate-200 bg-slate-50 shrink-0">
        ...
        <span className="ml-auto text-[11px] text-slate-400 hidden sm:block">SSNs, DOBs & card numbers are protected automatically · Ctrl+F to search</span>
      </div>
